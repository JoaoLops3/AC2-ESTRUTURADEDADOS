 ...
 * main.c
 *
 * Interface do usuário para o sistema de biblioteca.
 * Implementa um menu interativo para todas as operações disponíveis
 * e mede o tempo de execução de cada operação.
 */
 ...
 * Implementa o loop principal, processando as opções do usuário
 * e medindo o tempo de execução de cada operação.
 */
int main()
{
